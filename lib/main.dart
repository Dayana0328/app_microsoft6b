...
class _EstadocivilPageState extends State<EstadocivilPage> {
  ...
  Future<void> _fetchEstadocivilData() async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
          'https://educaysoft.org/microsoft6b/app/controllers/EstadocivilController.php?action=api',
        ),
      );
      if (response.statusCode == 200) {
        final List<dynamic> data = json.decode(response.body);
...
class _PersonaPageState extends State<PersonaPage> {
  ...
  Future<void> _fetchPersonaData() async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
          'https://educaysoft.org/microsoft6b/app/controllers/PersonaController.php?action=api',
        ),
      );
      if (response.statusCode == 200) {
        final List<dynamic> data = json.decode(response.body);
